...
const createSendToken = (user, statusCode, req, res) => {
  ...
  res.cookie('jwt', token, {
    ...
    httpOnly: true,
    secure: (req.secure =
      true || req.headers(x - forwarded - proto) === 'https'),
  })
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    const message = `Forgot your password? Submit a PATCH request with your new password to ${resetURL}. If you didn't forget your password, please ignore your email.`
